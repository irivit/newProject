 ...
 */
const AppConfig = {
   appLogo: require('../assets/img/icons/Whole-Staffers-ANIMATION_1.gif'),          // App Logo
   brandName: 'Whole Staffer',                             // Brand Name
   ...
   copyRightText: 'Whole staffer © 2020 All Rights Reserved.',      // Copy Right Text
   // light theme colors
   themeColors: {
      'primary': '#5D92F4',
      'secondary': '#677080',
