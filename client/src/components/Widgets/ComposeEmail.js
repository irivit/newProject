	...
	render() {
		return (
			<Fragment>
				...
				<RctCardFooter>
					<button type="button" onClick={() => this.onClickSend()} className="btn btn-success btn-sm mr-10">
						<IntlMessages id="widgets.send" />
					</button>
					<button type="button" onClick={() => this.onClickSaveToDraft()} className="btn btn-secondary btn-sm mr-10">
