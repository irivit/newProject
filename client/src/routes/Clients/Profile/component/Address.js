	...
	render() {
		...
		return (
			<div className="address-wrapper">
							...
							<div className={classnames("card-base", { 'border-primary': address.isDefault })}>
								<div className="d-flex justify-content-between">
									...
									<div className="list-action">
										<button type="button" className="rct-link-btn" onClick={() => this.onEditAddress(address)}><i className="ti-pencil"></i></button>
										<button type="button" className="rct-link-btn" onClick={() => this.onDeleteAddress(address)}><i className="ti-close"></i></button>
									</div>
								</div>
								<address>
				...
				<Button variant="contained" color="primary" className="text-white" onClick={this.toggle}>Add New Address</Button>
				<div className="py-50 w-50">
					<Collapse isOpen={this.state.collapse}>
						...
						<Form>
							...
							<Button variant="contained" color="primary" className="text-white" onClick={() => this.addNewAddress()}>Save</Button>
						</Form>
					</Collapse>
				</div>
				...
				<Modal isOpen={editAddressModal} toggle={() => this.toggleEditAddressModal()}>
					...
					<ModalFooter>
						<Button variant="contained" className="text-white btn-success" onClick={() => this.updateEditAddressModal()}>Update</Button>{' '}
